...
//
        ...
        try {
            ...
            System.out.println("Mögliche Ausstattungs eingaben!: ");
            String aust = searchAusstattungsId();
            rset = stmt.executeQuery(aust);
            while (rset.next()) {
                System.out.printf("%15s \t %s\n", rset.getString("typ"), rset.getString("ausstattungsid"));
            }
...
//            // 99, "2020-01-01", "2020-01-03", "Seehaus", 1  -> test eigaben
    ...
    private static String searchAusstattungsId() {
        return "select  A.typ, A.ausstattungsid from dbsys26.ausstattung A ";
    }
